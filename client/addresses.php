...
?>  
    <script>
        ...
        function setAddress() {
            ...
            var url="addresses.php?addressid="+value;
...
//Array ( [addressid] => -1 [title] => [default] => 0 [civilityid] => [firstname] => firstname [lastname] => lastname [address] => [postcode] => [city] => [countryid] => [phone] => [sendAddress] => Apply )
  ...
  <table  class="table table-borderless">
    ...
    <tr>
        <td> </td>
        <td style="text-align:right"> <a href="addresses.php?addressid=-1">Add an Address</td>
    ...
    <tr>
        ...
        <td>
        <?php if ($addressId==-1) {?>    
        <input type="button" class="btn btn-primary" value="Back"  onClick="document.location.href='addresses.php'" /> 
        <?php } else if ($addressId!=0){?>
        <input type="submit" class="btn btn-primary" value="Delete" name="deleteAddress"  /> 
        <?php }?>
        <input type="submit" class="btn btn-primary" value="Apply" name="sendAddress" onClick="return validateForm();" />
        </td>
